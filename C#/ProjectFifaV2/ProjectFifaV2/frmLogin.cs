    ...
    public partial class frmLogin : Form
    {
        ...
        private void btnRegister_Click(object sender, EventArgs e)
        {
            ...
            else
            {
                ...
                if (exist)
                {
                    MessageHandler.ShowMessage("This username already taken.");
                }
                else
                {
                    MessageHandler.ShowMessage("Your account has been registerd.");
                    using (SqlCommand cmd = new SqlCommand("INSERT INTO [tblUsers] ([Username], [Password], [IsAdmin], [Score]) VALUES (@Username, @Password, @IsAdmin, @Score)"))
                    {
                        ...
                        cmd.Parameters.AddWithValue("Score", startscore);
